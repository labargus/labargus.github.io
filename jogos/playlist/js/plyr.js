"object" == typeof navigator &&
    (function (e, t) {
        ...
        const qe = { pip: "PIP", airplay: "AirPlay", html5: "HTML5", vimeo: "Vimeo", youtube: "YouTube" },
            He = {
                get(e = "", t = {}) {
                    if (W(e) || W(t)) return "";
                    let i = Q(t.i18n, e);
        ...
        const We = {
            ...
            createButton(e, t) {
                ...
                return (
                    ...
                    G(a, i),
                    "play" === s ? (D(this.elements.buttons[s]) || (this.elements.buttons[s] = []), this.elements.buttons[s].push(a)) : (this.elements.buttons[s] = a),
                    a
                );
            },
            createRange(e, t) {
            ...
            setMarkers() {
                ...
                i.forEach((e) => {
                    ...
                    s.appendChild(n),
                    this.config.tooltips.seek || ((a = Z("span", { class: this.config.classNames.tooltip }, "")), s.appendChild(a)),
        ...
        class gt {
            constructor(t) {
                e(this, "load", () => {
                    ...
                    e(this, "on", (e, t) => (D(this.events[e]) || (this.events[e] = []), this.events[e].push(t), this)),
